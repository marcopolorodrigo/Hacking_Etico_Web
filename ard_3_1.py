...
class StatefulPacketFilter:
    """
    Simulación de un motor de filtrado de paquetes stateful (como pf).
    """
    ...
    def add_rule(self, rule: Dict):
        """
        Añade una regla de firewall.
        Formato: {"source": "IP/net", "dest": "IP/net", "protocol": "tcp/udp/icmp", "port": 80, "action": "allow/deny"}
        """
    ...
    def process_packet(self, protocol: str, src_ip: str, src_port: int,
        ...
        """
        Procesa un paquete con seguimiento de estado.
        """
    ...
    def _check_rules(self, protocol: str, src_ip: str, dest_ip: str, dest_port: int) -> bool:
        ...
        for rule in self.rules:
            # Coincidencia simple (en la práctica, se usarían máscaras de red)
