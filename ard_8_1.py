...
class AIActComplianceChecker:
    """
    Verificador de cumplimiento del AI Act para sistemas de IA.
    """
    ...
    def __init__(self, system_name: str):
        ...
        self.obligations = []
        self.deadlines = {
            "transparency_art50": "2 de agosto de 2026",
            "high_risk_annex3": "2 de diciembre de 2027",
            "content_marking_grace": "2 de diciembre de 2026"
        }
    ...
    def classify(self, system_type: str, domain: str,
        ...
        if system_type in ["social_scoring", "manipulative_subliminal", "csam_generation", "nudifier"]:
        ...
        self.obligations = ["Códigos de conducta voluntarios (Art. 95)"]
        return self._generate_result()
...
# Ejemplo de uso
checker = AIActComplianceChecker("Chatbot de Atención al Cliente")
...
for o in result['obligations']:
    print(f"  - {o}")
print(f"\nPlazos:")
for key, value in result.get('deadlines', {}).items():
    print(f"  - {key}: {value}")
